...
function main(molecule::String, l::Integer, beta::Integer, thresh::Float64, max_iter::Integer)
    ...
    println("Davidson")
    @time Σ, U = davidson(A, V, Naux, l, thresh, max_iter)
...
for molecule in molecules
    ...
    for beta in betas
        ...
        for (i, l) in enumerate(ls)
            ...
            for t in thresh
                println("Running with threshold = $t")
                main(molecule, nev, beta, t, 500)
            end
        end
    end
